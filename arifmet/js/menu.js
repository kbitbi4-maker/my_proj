...
function setMode(mode) {
    ...
    else if (mode === 'scales') { initScalesMode(); }
    else if (mode === 'mix') { initMixMode(); }
}
function initMixMode() { document.querySelector('.header-title').innerText = 'Режим: Микс 🎰 ▼'; window.mixStep = 0; generateMixExample(); }
function generateMixExample() {
    ...
    document.querySelector('.header-title').innerText = 'Режим: Микс 🎰 ▼'; window.mixStep++;
}
