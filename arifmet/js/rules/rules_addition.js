...
export const ADDITION_RULES = [
    {
        ...
        config: (ctx) => ({
            ...
            // На Фазе 1 borrow = 0, никаких лишних десятков или пустых рамок резерва нет!
    ...
    },
    {
        ...
        config: (ctx) => {
            ...
            return {
                ...
                // Универсальное зеркальное вычисление: кто округляется, тот получает (+borrow), кто отдает — получает (-borrow)
