...
export const MULTIPLICATION_RULES = [
    {
        ...
        config: (ctx) => ({
            layout: "monster-scene", status: "win", monsters: ctx.math.monsters, items: ctx.math.items, mClass: "monster-happy",
    ...
    },
    {
        ...
        config: (ctx) => ({
            layout: "monster-scene", status: "sad", monsters: ctx.math.monsters, items: ctx.math.items, mClass: "monster-sad",
    ...
    },
    {
        ...
        config: (ctx) => ({
            layout: "monster-scene", status: "play", monsters: ctx.math.monsters, items: ctx.math.items, mClass: "", subtitleHTML: null
        })
    }
];
