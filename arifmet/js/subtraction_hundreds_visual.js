...
export function renderSubtractionHundredsVisual() {
    ...
    if (report.phase === 1) {
        ...
        const content2 = buildSubHLayout(0, h2, genSubEmpty(data.num2, 0), true);
